...
from ddim_inversion import DDIMStableDiffusionPipeline
import argparse
...
def main(model_id, image_path, step_list, prompt_name_backward, forward_prompt, backward_prompts, out_img_save_path, cross_attention_injection_ratio, self_attention_injection_ratio, pretrained_model_name_or_path):
    ...
    pipe = DDIMStableDiffusionPipeline.from_pretrained(pretrained_model_name_or_path)
    ...
    for train_step in step_list:
        ...
        register_attention_control(inversion.model, None)
        ...
        with torch.no_grad():
            images = latent2image(ldm_stable.vae, latents.detach())
